...
const About = () => {
  ...
  return (
    <>
      ...
      >
        Versatile and self-motivated Full Stack Web Developer with a strong
        foundation in both front-end and back-end technologies with 3 years
        experience. As a self-taught learner, I have honed my skills through
        hands-on projects and a passion for staying at the forefront of web
        development trends. Proficient in latest technologies, and experienced
        in building dynamic, responsive web applications. My journey as a
        self-taught developer reflects a commitment to continuous improvement
        and a demonstrated ability to adapt to evolving technologies.
      </motion.p>
